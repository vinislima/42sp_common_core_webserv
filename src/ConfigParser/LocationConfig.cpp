...
LocationConfig::LocationConfig() : _path(""), _root(""), _autoindex(false), _redirectCode(0), _redirectUrl("") {}

LocationConfig::LocationConfig(const std::string& path) : _path(path), _root(""), _autoindex(false), _redirectCode(0), _redirectUrl("") {}
